...
This is the Single Station code base on the latest Swift Radio updates, all proceeds from this code go to support the Swift Radio project.

# Single Station setup

- Update your station infos in the `SwiftRadio-Settings.swift` file.
